...
export default function Hub() {
  ...
  return (
    <div className="">
      ...
      <main className="flex flex-col items-center gap-8 pt-8 group">
                  ...
                  popoverContent={
                    <div className="flex flex-col gap-4 ">
                      ...
                      <p className="text-sm text-start text-lightMode-colors-blue-700/70">
                        ...
                        buscas e pesquisas. Utilizando algoritmos avançados, ele
                        oferece resultados relevantes e personalizados com
                  ...
                  popoverContent={
                    <div className="flex flex-col gap-4 ">
                      ...
                      <p className="text-sm text-start text-lightMode-colors-blue-700/70">
                        ...
                        investigações mais inteligentes e precisas. Proteja sua
                        carga e tome decisões informadas com o poder do
                        mapeamento de rotas.
                      </p>
                    </div>
                  }
                ...
                <Card
                  ...
                  popoverContent={
                    <div className="flex flex-col gap-4 ">
                      ...
                      <p className="text-sm text-start text-lightMode-colors-blue-700/70">
                        Poderosa fusão entre o CargaSafe e o Averiguação360. Ele
                        permite a integração de dados desses sistemas,
                        ...
                        análise e tomada de decisões estratégicas com o poder do
                        mapeamento.
                      </p>
                    </div>
                  }
                  ...
                  popoverContent={
                    <div className="flex flex-col gap-4 ">
                      ...
                      <p className="text-sm text-start text-lightMode-colors-blue-700/70">
                        ...
                        com Histórico de Sinistros, é uma ferramenta fundamental
                        para a gestão de pessoal no setor de transporte. Ele
                        mantém um registro detalhado de motoristas e ajudantes
                        que estiveram envolvidos em incidentes ou sinistros
                        anteriores. Isso permite uma avaliação mais precisa do
                        histórico de segurança da equipe, contribuindo para a
                        tomada de decisões informadas e aprimorando a gestão de
                        riscos.
                      </p>
                    </div>
                  }
                  ...
                  popoverContent={
                    <div className="flex flex-col gap-4 ">
                      ...
                      <p className="text-sm text-start text-lightMode-colors-blue-700/70">
                        ...
                        delegacias e outros subsistemas, ele agiliza a troca de
                        informações vitais e fornece insights avançados para
                        auxiliar na localização e recuperação eficiente de
                        cargas perdidas. Aumente suas chances de sucesso na
                ...
                <Card
                  ...
                  popoverContent={
                    <div className="flex flex-col gap-4 ">
                      ...
                      <p className="text-sm text-start text-lightMode-colors-blue-700/70">
                        Gestão de relacionamento com clientes. Armazena de forma
                        segura e organizada informações vitais sobre seus
                        clientes, facilitando o acesso rápido a dados, histórico
                        e preferências. Capacita sua equipe a oferecer um
                        serviço personalizado e aprimorado, construindo
                        relacionamentos sólidos e impulsionando o sucesso do
                        negócio.
                      </p>
                    </div>
                  }
